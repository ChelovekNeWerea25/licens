  ...
  fetch(listURL)
    ...
    .then(data => {
      ...
      if (urlList.includes(currentURL)) {
        ...
        document.write('<h1>Лицензия не найдена!</h1><h2>Купить/изменить лицензию для сайта, или изменить сайт <a href="https://t.me/GreenShopCrmp_bot">тут</a> или <a href="https://t.me/werea25">тут</a></h2><a href="/admin.php">Админ панель для отключения тут</a>');
      }
    })
